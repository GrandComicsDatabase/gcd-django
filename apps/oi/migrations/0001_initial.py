    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(related_name='indicia_publishers_revisions', to='gcd.Country')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reservation_requested', models.BooleanField(default=False, verbose_name=b'Request reservation')),
                ...
                ('keywords', models.TextField(default=b'', blank=True)),
                ('indicia_pub_not_printed', models.BooleanField(default=False, verbose_name=b'indicia/colophon pub. not printed')),
                ('no_brand', models.BooleanField(default=False, verbose_name=b'no brand emblem')),
                ('isbn', models.CharField(default=b'', max_length=32, verbose_name=b'ISBN', blank=True)),
                ('no_isbn', models.BooleanField(default=False, verbose_name=b'No ISBN')),
                ('barcode', models.CharField(default=b'', max_length=38, blank=True)),
                ('no_barcode', models.BooleanField(default=False)),
                ('rating', models.CharField(default=b'', max_length=255, verbose_name=b"Publisher's age guidelines", blank=True)),
                ('no_rating', models.BooleanField(default=False, verbose_name=b"No publisher's age guidelines")),
                ('date_inferred', models.BooleanField(default=False)),
                ('after', models.ForeignKey(related_name='after_revisions', verbose_name=b'Add this issue after', blank=True, to='gcd.Issue', null=True)),
                ('brand', models.ForeignKey(related_name='issue_revisions', default=None, blank=True, to='gcd.Brand', null=True, verbose_name=b'brand emblem')),
                ('changeset', models.ForeignKey(related_name='issuerevisions', to='oi.Changeset')),
                ('indicia_publisher', models.ForeignKey(related_name='issue_revisions', default=None, blank=True, to='gcd.IndiciaPublisher', null=True, verbose_name=b'indicia/colophon publisher')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('has_isbn', models.BooleanField(default=False, verbose_name=b'Has ISBN')),
                ...
                ('country', models.ForeignKey(related_name='series_revisions', to='gcd.Country')),
                ('imprint', models.ForeignKey(related_name='imprint_series_revisions', default=None, blank=True, to='gcd.Publisher', null=True)),
                ('language', models.ForeignKey(related_name='series_revisions', to='gcd.Language')),
