...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('oi', ['BrandGroupRevision'])
        ...
        db.create_table('oi_brand_revision_group', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('brandrevision', models.ForeignKey(orm['oi.brandrevision'], null=False)),
            ('brandgroup', models.ForeignKey(orm['gcd.brandgroup'], null=False))
        ))
        db.create_unique('oi_brand_revision_group', ['brandrevision_id', 'brandgroup_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('oi_brand_revision_group')
