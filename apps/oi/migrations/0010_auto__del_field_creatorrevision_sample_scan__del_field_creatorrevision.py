...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CreatorRevision.sample_scan'
        db.delete_column('oi_creator_revision', 'sample_scan')

        # Deleting field 'CreatorRevision.portrait'
        db.delete_column('oi_creator_revision', 'portrait')


    def backwards(self, orm):
        # Adding field 'CreatorRevision.sample_scan'
        db.add_column('oi_creator_revision', 'sample_scan',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CreatorRevision.portrait'
        db.add_column('oi_creator_revision', 'portrait',
