...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SeriesRevision.color'
        db.add_column('oi_series_revision', 'color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'SeriesRevision.dimensions'
        db.add_column('oi_series_revision', 'dimensions',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'SeriesRevision.paper_stock'
        db.add_column('oi_series_revision', 'paper_stock',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'SeriesRevision.binding'
        db.add_column('oi_series_revision', 'binding',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'SeriesRevision.publishing_format'
        db.add_column('oi_series_revision', 'publishing_format',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SeriesRevision.color'
        db.delete_column('oi_series_revision', 'color')

        # Deleting field 'SeriesRevision.dimensions'
        db.delete_column('oi_series_revision', 'dimensions')

        # Deleting field 'SeriesRevision.paper_stock'
        db.delete_column('oi_series_revision', 'paper_stock')

        # Deleting field 'SeriesRevision.binding'
        db.delete_column('oi_series_revision', 'binding')

        # Deleting field 'SeriesRevision.publishing_format'
        db.delete_column('oi_series_revision', 'publishing_format')
