...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CreatorNonComicWorkRevision'
        db.create_table('oi_creatornoncomicworkrevision', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('changeset', self.gf('django.db.models.fields.related.ForeignKey')(related_name='creatornoncomicworkrevisions', to=orm['oi.Changeset'])),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, db_index=True, blank=True)),
            ('creator_noncomicwork', self.gf('django.db.models.fields.related.ForeignKey')(related_name='revisions', null=True, to=orm['gcd.NonComicWork'])),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cr_creator_noncomicwork', to=orm['gcd.Creator'])),
            ('work_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cr_worktype', null=True, to=orm['gcd.NonComicWorkType'])),
            ...
            ('work_role', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cr_workrole', null=True, to=orm['gcd.NonComicWorkRole'])),
            ('work_notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('oi', ['CreatorNonComicWorkRevision'])

        # Adding M2M table for field work_source on 'CreatorNonComicWorkRevision'
        m2m_table_name = db.shorten_name('oi_creatornoncomicworkrevision_work_source')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('creatornoncomicworkrevision', models.ForeignKey(orm['oi.creatornoncomicworkrevision'], null=False)),
            ('sourcetype', models.ForeignKey(orm['gcd.sourcetype'], null=False))
        ))
        db.create_unique(m2m_table_name, ['creatornoncomicworkrevision_id', 'sourcetype_id'])

        # Adding model 'CreatorMembershipRevision'
        db.create_table('oi_creatormembershiprevision', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('changeset', self.gf('django.db.models.fields.related.ForeignKey')(related_name='creatormembershiprevisions', to=orm['oi.Changeset'])),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, db_index=True, blank=True)),
            ('creator_membership', self.gf('django.db.models.fields.related.ForeignKey')(related_name='revisions', null=True, to=orm['gcd.Membership'])),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cr_creator_membership', to=orm['gcd.Creator'])),
            ('organization_name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('membership_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cr_membershiptype', null=True, to=orm['gcd.MembershipType'])),
        ...
        db.send_create_signal('oi', ['CreatorMembershipRevision'])

        # Adding M2M table for field membership_source on 'CreatorMembershipRevision'
        m2m_table_name = db.shorten_name('oi_creatormembershiprevision_membership_source')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('creatormembershiprevision', models.ForeignKey(orm['oi.creatormembershiprevision'], null=False)),
            ('sourcetype', models.ForeignKey(orm['gcd.sourcetype'], null=False))
        ))
        db.create_unique(m2m_table_name, ['creatormembershiprevision_id', 'sourcetype_id'])
        ...
        # Adding model 'CreatorArtInfluenceRevision'
        db.create_table('oi_creatorartinfluencerevision', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('changeset', self.gf('django.db.models.fields.related.ForeignKey')(related_name='creatorartinfluencerevisions', to=orm['oi.Changeset'])),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, db_index=True, blank=True)),
            ('creator_artinfluence', self.gf('django.db.models.fields.related.ForeignKey')(related_name='revisions', null=True, to=orm['gcd.ArtInfluence'])),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cr_creator_artinfluence', to=orm['gcd.Creator'])),
            ('influence_name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('influence_link', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cr_influencelink', null=True, to=orm['gcd.Creator'])),
        ...
        db.send_create_signal('oi', ['CreatorArtInfluenceRevision'])

        # Adding M2M table for field influence_source on 'CreatorArtInfluenceRevision'
        m2m_table_name = db.shorten_name('oi_creatorartinfluencerevision_influence_source')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('creatorartinfluencerevision', models.ForeignKey(orm['oi.creatorartinfluencerevision'], null=False)),
            ('sourcetype', models.ForeignKey(orm['gcd.sourcetype'], null=False))
        ))
        db.create_unique(m2m_table_name, ['creatorartinfluencerevision_id', 'sourcetype_id'])
        ...
        # Adding model 'CreatorAwardRevision'
        db.create_table('oi_creatorawardrevision', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('changeset', self.gf('django.db.models.fields.related.ForeignKey')(related_name='creatorawardrevisions', to=orm['oi.Changeset'])),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, db_index=True, blank=True)),
            ('creator_award', self.gf('django.db.models.fields.related.ForeignKey')(related_name='revisions', null=True, to=orm['gcd.Award'])),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cr_creator_award', to=orm['gcd.Creator'])),
        ...
        db.send_create_signal('oi', ['CreatorAwardRevision'])

        # Adding M2M table for field award_source on 'CreatorAwardRevision'
        m2m_table_name = db.shorten_name('oi_creatorawardrevision_award_source')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('creatorawardrevision', models.ForeignKey(orm['oi.creatorawardrevision'], null=False)),
            ('sourcetype', models.ForeignKey(orm['gcd.sourcetype'], null=False))
        ))
        db.create_unique(m2m_table_name, ['creatorawardrevision_id', 'sourcetype_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CreatorNonComicWorkRevision'
        db.delete_table('oi_creatornoncomicworkrevision')

        # Removing M2M table for field work_source on 'CreatorNonComicWorkRevision'
        db.delete_table(db.shorten_name('oi_creatornoncomicworkrevision_work_source'))

        # Deleting model 'CreatorMembershipRevision'
        db.delete_table('oi_creatormembershiprevision')

        # Removing M2M table for field membership_source on 'CreatorMembershipRevision'
        db.delete_table(db.shorten_name('oi_creatormembershiprevision_membership_source'))

        # Deleting model 'BioSourceRevision'
        db.delete_table('oi_biosourcerevision')

        # Deleting model 'CreatorArtInfluenceRevision'
        db.delete_table('oi_creatorartinfluencerevision')

        # Removing M2M table for field influence_source on 'CreatorArtInfluenceRevision'
        db.delete_table(db.shorten_name('oi_creatorartinfluencerevision_influence_source'))
        ...
        # Deleting model 'CreatorAwardRevision'
        db.delete_table('oi_creatorawardrevision')

        # Removing M2M table for field award_source on 'CreatorAwardRevision'
        db.delete_table(db.shorten_name('oi_creatorawardrevision_award_source'))
