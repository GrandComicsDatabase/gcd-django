...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'IssueRevision.rating'
        db.delete_column('oi_issue_revision', 'rating')

        # Deleting field 'IssueRevision.no_rating'
        db.delete_column('oi_issue_revision', 'no_rating')
