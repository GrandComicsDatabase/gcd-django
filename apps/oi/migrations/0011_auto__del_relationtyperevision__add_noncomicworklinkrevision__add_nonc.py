...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NonComicWorkLinkRevision'
        db.create_table('oi_noncomicworklinkrevision', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('changeset', self.gf('django.db.models.fields.related.ForeignKey')(related_name='noncomicworklinkrevisions', to=orm['oi.Changeset'])),
            ...
            ('creator_noncomicworklink', self.gf('django.db.models.fields.related.ForeignKey')(related_name='revisions', null=True, to=orm['gcd.NonComicWorkLink'])),
            ('non_comic_work', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cr_noncomicworklinks', to=orm['oi.CreatorNonComicWorkRevision'])),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=255)),
        ))
        db.send_create_signal('oi', ['NonComicWorkLinkRevision'])

        # Adding model 'NonComicWorkYearRevision'
        db.create_table('oi_noncomicworkyearrevision', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('changeset', self.gf('django.db.models.fields.related.ForeignKey')(related_name='noncomicworkyearrevisions', to=orm['oi.Changeset'])),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, db_index=True, blank=True)),
            ('creator_noncomicworkyear', self.gf('django.db.models.fields.related.ForeignKey')(related_name='revisions', null=True, to=orm['gcd.NonComicWorkYear'])),
            ('non_comic_work', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cr_noncomicworkyears', to=orm['oi.CreatorNonComicWorkRevision'])),
        ...
        db.send_create_signal('oi', ['NonComicWorkYearRevision'])

        # Deleting field 'NameRelationRevision.rel_source'
        db.delete_column('oi_namerelation_revision', 'rel_source')

        # Adding M2M table for field rel_source on 'NameRelationRevision'
        m2m_table_name = db.shorten_name('oi_namerelation_revision_rel_source')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('namerelationrevision', models.ForeignKey(orm['oi.namerelationrevision'], null=False)),
            ('sourcetype', models.ForeignKey(orm['gcd.sourcetype'], null=False))
        ))
        db.create_unique(m2m_table_name, ['namerelationrevision_id', 'sourcetype_id'])


        # Changing field 'NameRelationRevision.gcd_official_name'
        db.alter_column('oi_namerelation_revision', 'gcd_official_name_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oi.CreatorNameDetailsRevision']))

        # Changing field 'NameRelationRevision.rel_type'
        db.alter_column('oi_namerelation_revision', 'rel_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['gcd.RelationType']))

        # Changing field 'NameRelationRevision.to_name'
        db.alter_column('oi_namerelation_revision', 'to_name_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oi.CreatorNameDetailsRevision']))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'NonComicWorkLinkRevision'
        db.delete_table('oi_noncomicworklinkrevision')

        # Deleting model 'NonComicWorkYearRevision'
        db.delete_table('oi_noncomicworkyearrevision')

        # Adding field 'NameRelationRevision.rel_source'
        db.add_column('oi_namerelation_revision', 'rel_source',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field rel_source on 'NameRelationRevision'
        db.delete_table(db.shorten_name('oi_namerelation_revision_rel_source'))


        # Changing field 'NameRelationRevision.gcd_official_name'
        db.alter_column('oi_namerelation_revision', 'gcd_official_name_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oi.CreatorRevision']))

        # Changing field 'NameRelationRevision.rel_type'
        db.alter_column('oi_namerelation_revision', 'rel_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['oi.RelationTypeRevision']))

        # Changing field 'NameRelationRevision.to_name'
        db.alter_column('oi_namerelation_revision', 'to_name_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oi.CreatorRevision']))
    ...
    models = {
        ...
        'oi.namerelationrevision': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'gcd_official_name': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'creator_revise_gcd_official_name'", 'to': "orm['oi.CreatorNameDetailsRevision']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'db_index': 'True', 'blank': 'True'}),
            'name_relation': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'cr_name_relation'", 'null': 'True', 'to': "orm['gcd.NameRelation']"}),
            'rel_source': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['gcd.SourceType']", 'null': 'True', 'symmetrical': 'False'}),
            'rel_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'creator_revise_relation_type'", 'null': 'True', 'to': "orm['gcd.RelationType']"}),
            'to_name': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'creator_revise_to_name'", 'to': "orm['oi.CreatorNameDetailsRevision']"})
        },
        'oi.noncomicworklinkrevision': {
            'Meta': {'ordering': "('link',)", 'object_name': 'NonComicWorkLinkRevision'},
            'changeset': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'noncomicworklinkrevisions'", 'to': "orm['oi.Changeset']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'creator_noncomicworklink': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'revisions'", 'null': 'True', 'to': "orm['gcd.NonComicWorkLink']"}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.URLField', [], {'max_length': '255'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'db_index': 'True', 'blank': 'True'}),
            'non_comic_work': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'cr_noncomicworklinks'", 'to': "orm['oi.CreatorNonComicWorkRevision']"})
        },
        'oi.noncomicworkyearrevision': {
            'Meta': {'ordering': "('work_year',)", 'object_name': 'NonComicWorkYearRevision'},
            'changeset': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'noncomicworkyearrevisions'", 'to': "orm['oi.Changeset']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'creator_noncomicworkyear': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'revisions'", 'null': 'True', 'to': "orm['gcd.NonComicWorkYear']"}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'db_index': 'True', 'blank': 'True'}),
            'non_comic_work': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'cr_noncomicworkyears'", 'to': "orm['oi.CreatorNonComicWorkRevision']"}),
            'work_year': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'work_year_uncertain': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
