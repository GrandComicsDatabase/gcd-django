...
def patched_for_save():
    ...
    with mock.patch('django.db.models.base.Model.save') as save_mock, \
            mock.patch('apps.gcd.models.story.Story.__unicode__', story_uni), \
            mock.patch('apps.gcd.models.issue.Issue.__unicode__', issue_uni):
...
def test_handle_prerequisites(patched_for_commit):
    ...
    target_rev.commit_to_display.assert_called_once_with()
