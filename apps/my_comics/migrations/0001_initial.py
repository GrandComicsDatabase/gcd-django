...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('my_comics_collector', (
            ...
            ('default_have_collection', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['my_comics.Collection'])),
            ('default_want_collection', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['my_comics.Collection'])),
            ('default_language', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['gcd.Language'])),
        ))
        db.send_create_signal('my_comics', ['Collector'])

        # Adding model 'Collection'
        db.create_table('my_comics_collection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('collector', self.gf('django.db.models.fields.related.ForeignKey')(related_name='collections', to=orm['my_comics.Collector'])),
        ...
        db.send_create_signal('my_comics', ['Collection'])

        # Adding model 'Location'
        db.create_table('my_comics_location', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['my_comics.Collector'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('my_comics', ['Location'])

        # Adding model 'PurchaseLocation'
        db.create_table('my_comics_purchaselocation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['my_comics.Collector'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('my_comics', ['PurchaseLocation'])

        # Adding model 'CollectionItem'
        db.create_table('my_comics_collectionitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gcd.Issue'])),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['my_comics.Location'])),
            ('purchase_location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['my_comics.PurchaseLocation'])),
            ...
            ('price_paid_currency', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['stddata.Currency'])),
            ('market_value', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('market_value_currency', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['stddata.Currency'])),
            ('sell_price', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('sell_price_currency', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['stddata.Currency'])),
        ))
        db.send_create_signal('my_comics', ['CollectionItem'])

        # Adding M2M table for field collections on 'CollectionItem'
        db.create_table('my_comics_collectionitem_collections', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('collectionitem', models.ForeignKey(orm['my_comics.collectionitem'], null=False)),
            ('collection', models.ForeignKey(orm['my_comics.collection'], null=False))
        ))
        db.create_unique('my_comics_collectionitem_collections', ['collectionitem_id', 'collection_id'])


    def backwards(self, orm):
        # Deleting model 'Collector'
        db.delete_table('my_comics_collector')

        # Deleting model 'Collection'
        db.delete_table('my_comics_collection')

        # Deleting model 'Location'
        db.delete_table('my_comics_location')

        # Deleting model 'PurchaseLocation'
        db.delete_table('my_comics_purchaselocation')

        # Deleting model 'CollectionItem'
        db.delete_table('my_comics_collectionitem')

        # Removing M2M table for field collections on 'CollectionItem'
        db.delete_table('my_comics_collectionitem_collections')
    ...
    models = {
        ...
        'my_comics.collection': {
            'Meta': {'object_name': 'Collection'},
            'acquisition_date_used': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'collector': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'collections'", 'to': "orm['my_comics.Collector']"}),
        ...
        'my_comics.collectionitem': {
            ...
            'collections': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'items'", 'symmetrical': 'False', 'to': "orm['my_comics.Collection']"}),
            ...
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['my_comics.Location']"}),
            ...
            'purchase_location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['my_comics.PurchaseLocation']"}),
        ...
        'my_comics.collector': {
            ...
            'default_have_collection': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['my_comics.Collection']"}),
            'default_language': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['gcd.Language']"}),
            'default_want_collection': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['my_comics.Collection']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'my_comics.location': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['my_comics.Collector']"})
        },
        'my_comics.purchaselocation': {
