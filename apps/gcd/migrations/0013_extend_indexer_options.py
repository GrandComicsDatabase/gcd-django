...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Indexer.opt_in_email'
        db.add_column('gcd_indexer', 'opt_in_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'Indexer.issue_detail'
        db.add_column('gcd_indexer', 'issue_detail',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Indexer.opt_in_email'
        db.delete_column('gcd_indexer', 'opt_in_email')

        # Deleting field 'Indexer.issue_detail'
        db.delete_column('gcd_indexer', 'issue_detail')
