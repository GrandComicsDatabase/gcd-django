...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        call_command("loaddata", "seriesbond.yaml")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 26, 7, 50, 10, 724579)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 26, 7, 50, 10, 724507)'}),
