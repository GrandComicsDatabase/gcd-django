...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Series.has_rating'
        db.add_column('gcd_series', 'has_rating', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Issue.rating'
        db.add_column('gcd_issue', 'rating', self.gf('django.db.models.fields.CharField')(default='', max_length=255, db_index=True), keep_default=False)

        # Adding field 'Issue.no_rating'
        db.add_column('gcd_issue', 'no_rating', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Series.has_rating'
        db.delete_column('gcd_series', 'has_rating')

        # Deleting field 'Issue.rating'
        db.delete_column('gcd_issue', 'rating')

        # Deleting field 'Issue.no_rating'
        db.delete_column('gcd_issue', 'no_rating')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 13, 19, 14, 58, 217712)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 13, 19, 14, 58, 217622)'}),
