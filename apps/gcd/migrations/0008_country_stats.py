...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CountStats.country'
        db.add_column('gcd_count_stats', 'country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gcd.Country'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CountStats.country'
        db.delete_column('gcd_count_stats', 'country_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 1, 19, 59, 50, 713747)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 1, 19, 59, 50, 713656)'}),
