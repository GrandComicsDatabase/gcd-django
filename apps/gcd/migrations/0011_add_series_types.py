...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Series.publication_type'
        db.add_column('gcd_series', 'publication_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gcd.SeriesPublicationType'], null=True, blank=True), keep_default=False)

        # Adding field 'Series.is_singleton'
        db.add_column('gcd_series', 'is_singleton', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Series.publication_type'
        db.delete_column('gcd_series', 'publication_type_id')

        # Deleting field 'Series.is_singleton'
        db.delete_column('gcd_series', 'is_singleton')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 1, 15, 23, 25, 263931)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 1, 15, 23, 25, 263661)'}),
