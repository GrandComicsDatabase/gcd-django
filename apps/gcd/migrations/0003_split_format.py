...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Series.color'
        db.add_column('gcd_series', 'color',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255),
                      keep_default=False)

        # Adding field 'Series.dimensions'
        db.add_column('gcd_series', 'dimensions',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255),
                      keep_default=False)

        # Adding field 'Series.paper_stock'
        db.add_column('gcd_series', 'paper_stock',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255),
                      keep_default=False)

        # Adding field 'Series.binding'
        db.add_column('gcd_series', 'binding',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255),
                      keep_default=False)

        # Adding field 'Series.publishing_format'
        db.add_column('gcd_series', 'publishing_format',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Series.color'
        db.delete_column('gcd_series', 'color')

        # Deleting field 'Series.dimensions'
        db.delete_column('gcd_series', 'dimensions')

        # Deleting field 'Series.paper_stock'
        db.delete_column('gcd_series', 'paper_stock')

        # Deleting field 'Series.binding'
        db.delete_column('gcd_series', 'binding')

        # Deleting field 'Series.publishing_format'
        db.delete_column('gcd_series', 'publishing_format')
