...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Award.reserved'
        db.add_column('gcd_award', 'reserved',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'Award.created'
        db.add_column('gcd_award', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 9, 30, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Award.modified'
        db.add_column('gcd_award', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 9, 30, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Award.deleted'
        db.add_column('gcd_award', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'Membership.reserved'
        db.add_column('gcd_membership', 'reserved',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'Membership.created'
        db.add_column('gcd_membership', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 9, 30, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Membership.modified'
        db.add_column('gcd_membership', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 9, 30, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Membership.deleted'
        db.add_column('gcd_membership', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'NonComicWork.reserved'
        db.add_column('gcd_noncomicwork', 'reserved',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'NonComicWork.created'
        db.add_column('gcd_noncomicwork', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 9, 30, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'NonComicWork.modified'
        db.add_column('gcd_noncomicwork', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 9, 30, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'NonComicWork.deleted'
        db.add_column('gcd_noncomicwork', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


        # Changing field 'NonComicWork.publication_title'
        db.alter_column('gcd_noncomicwork', 'publication_title', self.gf('django.db.models.fields.CharField')(default='rajan', max_length=200))
        # Adding field 'ArtInfluence.reserved'
        db.add_column('gcd_artinfluence', 'reserved',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'ArtInfluence.created'
        db.add_column('gcd_artinfluence', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 9, 30, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'ArtInfluence.modified'
        db.add_column('gcd_artinfluence', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 9, 30, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'ArtInfluence.deleted'
        db.add_column('gcd_artinfluence', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Award.reserved'
        db.delete_column('gcd_award', 'reserved')

        # Deleting field 'Award.created'
        db.delete_column('gcd_award', 'created')

        # Deleting field 'Award.modified'
        db.delete_column('gcd_award', 'modified')

        # Deleting field 'Award.deleted'
        db.delete_column('gcd_award', 'deleted')

        # Deleting field 'Membership.reserved'
        db.delete_column('gcd_membership', 'reserved')

        # Deleting field 'Membership.created'
        db.delete_column('gcd_membership', 'created')

        # Deleting field 'Membership.modified'
        db.delete_column('gcd_membership', 'modified')

        # Deleting field 'Membership.deleted'
        db.delete_column('gcd_membership', 'deleted')

        # Deleting field 'NonComicWork.reserved'
        db.delete_column('gcd_noncomicwork', 'reserved')

        # Deleting field 'NonComicWork.created'
        db.delete_column('gcd_noncomicwork', 'created')

        # Deleting field 'NonComicWork.modified'
        db.delete_column('gcd_noncomicwork', 'modified')

        # Deleting field 'NonComicWork.deleted'
        db.delete_column('gcd_noncomicwork', 'deleted')


        # Changing field 'NonComicWork.publication_title'
        db.alter_column('gcd_noncomicwork', 'publication_title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
        # Deleting field 'ArtInfluence.reserved'
        db.delete_column('gcd_artinfluence', 'reserved')

        # Deleting field 'ArtInfluence.created'
        db.delete_column('gcd_artinfluence', 'created')

        # Deleting field 'ArtInfluence.modified'
        db.delete_column('gcd_artinfluence', 'modified')

        # Deleting field 'ArtInfluence.deleted'
        db.delete_column('gcd_artinfluence', 'deleted')
    ...
    models = {
        ...
        'gcd.artinfluence': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 30, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 30, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
