...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('gcd_creatorschooldetail', (
            ...
            ('school', self.gf('django.db.models.fields.related.ForeignKey')(related_name='school_details', to=orm['gcd.School'])),
        ...
        db.send_create_signal('gcd', ['CreatorSchoolDetail'])

        # Adding M2M table for field school_source on 'CreatorSchoolDetail'
        m2m_table_name = db.shorten_name('gcd_creatorschooldetail_school_source')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('creatorschooldetail', models.ForeignKey(orm['gcd.creatorschooldetail'], null=False)),
