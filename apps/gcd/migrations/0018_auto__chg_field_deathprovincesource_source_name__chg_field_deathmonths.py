...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DeathProvinceSource.source_name'
        db.alter_column('gcd_deathprovincesource', 'source_name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'DeathMonthSource.source_name'
        db.alter_column('gcd_deathmonthsource', 'source_name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'BirthCitySource.source_name'
        db.alter_column('gcd_birthcitysource', 'source_name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'BirthProvinceSource.source_name'
        db.alter_column('gcd_birthprovincesource', 'source_name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'BioSource.source_name'
        db.alter_column('gcd_biosource', 'source_name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'BirthYearSource.source_name'
        db.alter_column('gcd_birthyearsource', 'source_name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'BirthCountrySource.source_name'
        db.alter_column('gcd_birthcountrysource', 'source_name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'DeathCitySource.source_name'
        db.alter_column('gcd_deathcitysource', 'source_name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'PortraitSource.source_name'
        db.alter_column('gcd_portraitsource', 'source_name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'DeathDateSource.source_name'
        db.alter_column('gcd_deathdatesource', 'source_name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'DeathYearSource.source_name'
        db.alter_column('gcd_deathyearsource', 'source_name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'DeathCountrySource.source_name'
        db.alter_column('gcd_deathcountrysource', 'source_name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'NameSource.source_name'
        db.alter_column('gcd_namesource', 'source_name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'BirthDateSource.source_name'
        db.alter_column('gcd_birthdatesource', 'source_name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'BirthMonthSource.source_name'
        db.alter_column('gcd_birthmonthsource', 'source_name', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'DeathProvinceSource.source_name'
        db.alter_column('gcd_deathprovincesource', 'source_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'DeathMonthSource.source_name'
        db.alter_column('gcd_deathmonthsource', 'source_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'BirthCitySource.source_name'
        db.alter_column('gcd_birthcitysource', 'source_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'BirthProvinceSource.source_name'
        db.alter_column('gcd_birthprovincesource', 'source_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'BioSource.source_name'
        db.alter_column('gcd_biosource', 'source_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'BirthYearSource.source_name'
        db.alter_column('gcd_birthyearsource', 'source_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'BirthCountrySource.source_name'
        db.alter_column('gcd_birthcountrysource', 'source_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'DeathCitySource.source_name'
        db.alter_column('gcd_deathcitysource', 'source_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'PortraitSource.source_name'
        db.alter_column('gcd_portraitsource', 'source_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'DeathDateSource.source_name'
        db.alter_column('gcd_deathdatesource', 'source_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'DeathYearSource.source_name'
        db.alter_column('gcd_deathyearsource', 'source_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'DeathCountrySource.source_name'
        db.alter_column('gcd_deathcountrysource', 'source_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'NameSource.source_name'
        db.alter_column('gcd_namesource', 'source_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'BirthDateSource.source_name'
        db.alter_column('gcd_birthdatesource', 'source_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'BirthMonthSource.source_name'
        db.alter_column('gcd_birthmonthsource', 'source_name', self.gf('django.db.models.fields.CharField')(max_length=100))
