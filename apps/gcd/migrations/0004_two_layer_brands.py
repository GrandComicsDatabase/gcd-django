...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Series.imprint'
        db.delete_column('gcd_series', 'imprint_id')

        # Adding M2M table for field group on 'Brand'
        db.create_table('gcd_brand_emblem_group', (
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Series.imprint'
        db.add_column('gcd_series', 'imprint', self.gf('django.db.models.fields.related.ForeignKey')(related_name='imprint_series_set', null=True, to=orm['gcd.Publisher']), keep_default=False)
