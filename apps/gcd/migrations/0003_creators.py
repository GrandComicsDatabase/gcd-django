...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='data_source',
            field=models.ManyToManyField(to='gcd.DataSource', blank=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='creatorschool',
        ...
        migrations.AddField(
            model_name='creatordegree',
            name='school',
            field=models.ForeignKey(related_name='degree', blank=True, to='gcd.School', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='creator',
            name='degrees',
            field=models.ManyToManyField(related_name='degreeinformation', null=True, through='gcd.CreatorDegree', to='gcd.Degree', blank=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='creator',
            name='schools',
            field=models.ManyToManyField(related_name='schoolinformation', null=True, through='gcd.CreatorSchool', to='gcd.School', blank=True),
            preserve_default=True,
        ),
    ]
