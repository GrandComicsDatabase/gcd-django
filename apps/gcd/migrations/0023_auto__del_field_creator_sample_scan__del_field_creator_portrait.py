...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Creator.sample_scan'
        db.delete_column('gcd_creator', 'sample_scan')

        # Deleting field 'Creator.portrait'
        db.delete_column('gcd_creator', 'portrait')


    def backwards(self, orm):
        # Adding field 'Creator.sample_scan'
        db.add_column('gcd_creator', 'sample_scan',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Creator.portrait'
        db.add_column('gcd_creator', 'portrait',
    ...
    models = {
        ...
        'gcd.artinfluence': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 8, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 8, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
