...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NameRelation.rel_type'
        db.alter_column('gcd_namerelation', 'rel_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['gcd.RelationType']))

        # Changing field 'NameRelation.to_name'
        db.alter_column('gcd_namerelation', 'to_name_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gcd.CreatorNameDetails']))

        # Changing field 'NameRelation.gcd_official_name'
        db.alter_column('gcd_namerelation', 'gcd_official_name_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gcd.CreatorNameDetails']))

    def backwards(self, orm):

        # Changing field 'NameRelation.rel_type'
        db.alter_column('gcd_namerelation', 'rel_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['gcd.RelationType']))

        # Changing field 'NameRelation.to_name'
        db.alter_column('gcd_namerelation', 'to_name_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gcd.Creator']))

        # Changing field 'NameRelation.gcd_official_name'
        db.alter_column('gcd_namerelation', 'gcd_official_name_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gcd.Creator']))
    ...
    models = {
        ...
        'gcd.artinfluence': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 6, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 6, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'gcd.namerelation': {
            ...
            'gcd_official_name': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'creator_gcd_official_name'", 'to': "orm['gcd.CreatorNameDetails']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rel_source': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['gcd.SourceType']", 'null': 'True', 'symmetrical': 'False'}),
            'rel_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'relation_type'", 'null': 'True', 'to': "orm['gcd.RelationType']"}),
            'to_name': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'to_name'", 'to': "orm['gcd.CreatorNameDetails']"})
        },
        'gcd.nametype': {
        ...
        'gcd.noncomicworklink': {
            ...
            'non_comic_work': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'noncomicworklinks'", 'to': "orm['gcd.NonComicWork']"})
        },
        ...
        'gcd.noncomicworkyear': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'non_comic_work': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'noncomicworkyears'", 'to': "orm['gcd.NonComicWork']"}),
