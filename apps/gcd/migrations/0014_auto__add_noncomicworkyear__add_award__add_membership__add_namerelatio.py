...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('gcd_award', (
            ...
            ('award_source', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        ...
        db.create_table('gcd_membership', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gcd.Creator'])),
            ('membership_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gcd.MembershipType'])),
            ('membership_begin_year', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('membership_end_year', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('membership_source', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        ...
        db.create_table('gcd_namerelation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('gcd_official_name', self.gf('django.db.models.fields.related.ForeignKey')(related_name='gcd_official_name', to=orm['gcd.Creator'])),
        ...
        db.create_table('gcd_school', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='creator_school', to=orm['gcd.Creator'])),
            ...
            ('school_source', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        ...
        db.create_table('gcd_noncomicwork', (
            ...
            ('publication_title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ...
            ('work_role', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gcd.NonComicWorkRole'])),
            ('work_source', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ...
        db.create_table('gcd_artinfluence', (
            ...
            ('is_influence_exist', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('influence_source', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        ...
        db.create_table('gcd_creator', (
            ...
            ('source_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gcd.SourceType'])),
            ...
            ('birth_year_source', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('birth_month_source', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('birth_date_source', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('death_year_source', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('death_month_source', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('death_date_source', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('birth_country_source', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('birth_province_source', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('birth_city_source', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('death_country_source', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('death_province_source', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('death_city_source', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('portrait', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('portrait_source', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('bio', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('bio_source', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ...
        db.create_table('gcd_degree', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('school', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gcd.School'])),
