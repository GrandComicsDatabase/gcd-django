...
urlpatterns = patterns('',
    ...
    url(r'^publisher/name/(?P<publisher_name>.+)/sort/(?P<sort>.+)/$',
     'apps.gcd.views.search.publisher_by_name_haystack', name='publisher_by_name'),
    ...
    url(r'^brand_group/name/(?P<brand_group_name>.+)/sort/(?P<sort>.+)/$',
     'apps.gcd.views.search.brand_group_by_name_haystack',
    ...
    url(r'^brand/name/(?P<brand_name>.+)/sort/(?P<sort>.+)/$',
     'apps.gcd.views.search.brand_by_name_haystack', name='brand_by_name'),
    ...
    url(r'^indicia_publisher/name/(?P<ind_pub_name>.+)/sort/(?P<sort>.+)/$',
     'apps.gcd.views.search.indicia_publisher_by_name_haystack',
    ...
    url(r'^series/name/(?P<series_name>.+)/sort/(?P<sort>.+)/$',
     'apps.gcd.views.search.series_by_name_haystack', name='series_by_name'),
