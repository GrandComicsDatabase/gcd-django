...
urlpatterns = patterns('',
    ...
    url(r'^creator_membership/(?P<creator_membership_id>\d+)/$',
     'apps.gcd.views.details.creator_membership', name='show_creator_membership'),
    url(r'^creator_membership/name/(?P<creator_membership_name>.+)/sort/(?P<sort>.+)/$',
     'apps.gcd.views.search.creator_membership_by_name',
    ...
    url(r'^creator_award/(?P<creator_award_id>\d+)/$',
     'apps.gcd.views.details.creator_award', name='show_creator_award'),
    url(r'^creator_award/name/(?P<creator_award_name>.+)/sort/(?P<sort>.+)/$',
     'apps.gcd.views.search.creator_award_by_name',
     name='creator_award_by_name'),
    url(r'^creator_award/name/(?P<creator_award_name>.+)/$',
     'apps.gcd.views.search.creator_award_by_name',
     name='creator_award_by_name'),

    url(r'^creator_artinfluence/(?P<creator_artinfluence_id>\d+)/$',
     'apps.gcd.views.details.creator_artinfluence', name='show_creator_artinfluence'),
    url(r'^creator_artinfluence/name/(?P<creator_artinfluence_name>.+)/sort/(?P<sort>.+)/$',
     'apps.gcd.views.search.creator_artinfluence_by_name',
     name='creator_artinfluence_by_name'),
    url(r'^creator_artinfluence/name/(?P<creator_artinfluence_name>.+)/$',
     'apps.gcd.views.search.creator_artinfluence_by_name',
     name='creator_artinfluence_by_name'),

    url(r'^creator_noncomicwork/(?P<creator_noncomicwork_id>\d+)/$',
     'apps.gcd.views.details.creator_noncomicwork', name='show_creator_noncomicwork'),
    url(r'^creator_noncomicwork/name/(?P<creator_noncomicwork_name>.+)/sort/(?P<sort>.+)/$',
     'apps.gcd.views.search.creator_noncomicwork_by_name',
     name='creator_noncomicwork_by_name'),
    url(r'^creator_noncomicwork/name/(?P<creator_noncomicwork_name>.+)/$',
     'apps.gcd.views.search.creator_noncomicwork_by_name',
     name='creator_noncomicwork_by_name'),
    ...
    url(r'^creator_degree/(?P<creator_degree_id>\d+)/$',
     'apps.gcd.views.details.creator_degree', name='show_creator_degree'),
...
urlpatterns += patterns('',
    ...
    ('^covers_for_replacement.lasso/$',
      bv.RedirectView.as_view(url='/covers_to_replace/',
                              permanent=True)),
    ('^index.lasso/$', bv.RedirectView.as_view(url='/', permanent=True)),
    ('^donate.lasso/$', bv.RedirectView.as_view(url='/donate/',
                                                permanent=True)),
    (r'^graphics/covers/', bv.RedirectView.as_view(url=None, permanent=True)),
