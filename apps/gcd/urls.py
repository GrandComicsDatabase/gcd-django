...
urlpatterns = [
    ...
    path('story_arc/name/',
     gcd_views.search.story_arc_by_name, name='story_arc_by_name'),
    ...
    path('universe/<int:universe_id>/groups/',
      gcd_views.details.universe_groups, name='universe_groups'),
    ...
    re_path(r'^character_name/(?P<character_name_id>\d+)/universe/(?P<universe_id>-?\d+)/issues/$',
    ...
    path('character/<int:character_id>/character/<int:character_with_id>/issues/',
      gcd_views.details.character_issues_character, name='character_issues_character'),
    path('character/<int:character_id>/groups/',
      gcd_views.details.character_groups, name='character_groups'),
    path('character/<int:character_id>/group/<int:group_id>/issues/',
      gcd_views.details.character_issues_group, name='character_issues_group'),
    ...
    re_path(r'^character/(?P<character_id>\d+)/character_universe/(?P<universe_id>-?\d+)/story_universe/(?P<story_universe_id>-?\d+)/issues/$',
      gcd_views.details.character_issues, name='character_story_issues_per_universe'),
    re_path(r'^character/(?P<character_id>\d+)/story_universe/(?P<story_universe_id>-?\d+)/issues/$',
      gcd_views.details.character_issues, name='character_story_issues_per_universe'),
    ...
    re_path(r'^character/(?P<character_id>\d+)/series/(?P<series_id>-?\d+)/issues/$',
      gcd_views.details.character_issues_series, name='character_issues_per_series'),
    re_path(r'^character/(?P<character_id>\d+)/feature/(?P<feature_id>-?\d+)/issues/$',
    ...
    # Character Universe Origin
    re_path(r'^character/(?P<character_id>\d+)/character_origin_universe/(?P<universe_id>-?\d+)/$',
      gcd_views.details.character_origin_universe, name='character_origin_universe'),
    re_path(r'^character/(?P<character_id>\d+)/character_origin_universe/(?P<universe_id>-?\d+)/issues/$',
      gcd_views.details.character_issues, name='character_origin_universe_issues'),
    re_path(r'^character/(?P<character_id>\d+)/character_origin_universe/(?P<universe_id>-?\d+)/creators/$',
      gcd_views.details.character_creators, name='character_origin_universe_creators'),
    re_path(r'^character/(?P<character_id>\d+)/character_origin_universe/(?P<universe_id>-?\d+)/creator_names/$',
      gcd_views.details.character_creators, {'creator_names': True},
      name='character_origin_universe_creator_names'),
    re_path(r'^character/(?P<character_id>\d+)/character_origin_universe/(?P<universe_id>-?\d+)/creator/(?P<creator_id>\d+)/issues/$',
      gcd_views.details.creator_issues, name='character_origin_universe_creator_issues'),
    re_path(r'^character/(?P<character_id>\d+)/character_origin_universe/(?P<universe_id>-?\d+)/creator_name/(?P<creator_name_id>\d+)/issues/$',
      gcd_views.details.creator_name_issues, name='character_origin_universe_creator_name_issues'),
    re_path(r'^character/(?P<character_id>\d+)/character_origin_universe/(?P<universe_id>-?\d+)/covers/$',
      gcd_views.details.character_covers, name='character_origin_universe_covers'),
    re_path(r'^character/(?P<character_id>\d+)/character_origin_universe/(?P<universe_id>-?\d+)/series/$',
      gcd_views.details.character_series, name='character_origin_universe_series'),
    re_path(r'^character/(?P<character_id>\d+)/character_origin_universe/(?P<universe_id>-?\d+)/series/(?P<series_id>\d+)/issues/$',
      gcd_views.details.character_issues_series, name='character_origin_universe_issues_per_series'),
    re_path(r'^character/(?P<character_id>\d+)/character_origin_universe/(?P<universe_id>-?\d+)/features/$',
      gcd_views.details.character_features, name='character_origin_universe_features'),
    re_path(r'^character/(?P<character_id>\d+)/character_origin_universe/(?P<universe_id>-?\d+)/feature/(?P<feature_id>\d+)/issues/$',
      gcd_views.details.character_issues_feature, name='character_origin_universe_issues_per_feature'),
    re_path(r'^character/(?P<character_id>\d+)/character_origin_universe/(?P<universe_id>-?\d+)/characters/$',
      gcd_views.details.character_characters, name='character_origin_universe_characters'),
    re_path(r'^character/(?P<character_id>\d+)/character_origin_universe/(?P<universe_id>-?\d+)/with_character/(?P<character_with_id>\d+)/$',
      gcd_views.details.character_issues_character, name='character_origin_universe_issues_per_character'),
    re_path(r'^character/(?P<character_id>\d+)/character_origin_universe/(?P<universe_id>-?\d+)/group/(?P<group_id>\d+)/$',
      gcd_views.details.character_issues_group, name='character_origin_universe_issues_group'),
    re_path(r'^character/(?P<character_id>\d+)/character_origin_universe/(?P<universe_id>-?\d+)/sequences/$',
      gcd_views.details.character_sequences, name='character_origin_universe_sequences'),
    re_path(r'^character_name/(?P<character_name_id>\d+)/character_origin_universe/(?P<universe_id>-?\d+)/issues/$',
      gcd_views.details.character_name_issues, name='character_name_origin_universe_issues'),
    re_path(r'^character/(?P<character_id>\d+)/character_origin_universe/(?P<universe_id>-?\d+)/story_universe/(?P<story_universe_id>-?\d+)/$',
      gcd_views.details.character_issues, name='character_origin_universe_story_issues_per_universe'),
    path('group/search/',
    ...
    path('group/<int:group_id>/features/',
      gcd_views.details.group_features, name='group_features'),
    ...
    re_path(r'^group/(?P<group_id>\d+)/issues/story_universe/(?P<story_universe_id>-?\d+)/$',
      gcd_views.details.group_issues, name='group_story_issues_per_universe'),
    re_path(r'^group/(?P<group_id>\d+)/issues/series/(?P<series_id>-?\d+)/$',
      gcd_views.details.group_issues_series, name='group_issues_per_series'),
    re_path(r'^group/(?P<group_id>\d+)/issues/feature/(?P<feature_id>-?\d+)/$',
      gcd_views.details.group_issues_feature, name='group_issues_per_feature'),
    ...
    path('group/<int:group_id>/characters/',
      gcd_views.details.group_characters, name='group_characters'),
    path('group/<int:group_id>/series/',
      gcd_views.details.group_series, name='group_series'),
    path('group/<int:group_id>/covers/',
      gcd_views.details.group_covers, name='group_covers'),
    ...
    # Group Universe Origin
    re_path(r'^group/(?P<group_id>\d+)/group_origin_universe/(?P<universe_id>-?\d+)/$',
      gcd_views.details.group_origin_universe, name='group_origin_universe'),
    re_path(r'^group/(?P<group_id>\d+)/group_origin_universe/(?P<universe_id>-?\d+)/creators/$',
      gcd_views.details.group_creators, name='group_origin_universe_creators'),
    re_path(r'^group/(?P<group_id>\d+)/group_origin_universe/(?P<universe_id>-?\d+)/creator_names/$',
      gcd_views.details.group_creators, {'creator_names': True},
      name='group_origin_universe_creator_names'),
    re_path(r'^group/(?P<group_id>\d+)/group_origin_universe/(?P<universe_id>-?\d+)/creator/(?P<creator_id>\d+)/issues/$',
      gcd_views.details.creator_issues, name='group_origin_universe_creator_issues'),
    re_path(r'^group/(?P<group_id>\d+)/group_origin_universe/(?P<universe_id>-?\d+)/creator_name/(?P<creator_name_id>\d+)/issues/$',
      gcd_views.details.creator_name_issues, name='group_origin_universe_creator_name_issues'),
    re_path(r'^group/(?P<group_id>\d+)/group_origin_universe/(?P<universe_id>-?\d+)/issues/$',
      gcd_views.details.group_issues, name='group_origin_universe_issues'),
    re_path(r'^group/(?P<group_id>\d+)/group_origin_universe/(?P<universe_id>-?\d+)/covers/$',
      gcd_views.details.group_covers, name='group_origin_universe_covers'),
    re_path(r'^group/(?P<group_id>\d+)/group_origin_universe/(?P<universe_id>-?\d+)/series/$',
      gcd_views.details.group_series, name='group_origin_universe_series'),
    re_path(r'^group/(?P<group_id>\d+)/group_origin_universe/(?P<universe_id>-?\d+)/series/(?P<series_id>\d+)/issues/$',
      gcd_views.details.group_issues_series, name='group_origin_universe_issues_per_series'),
    re_path(r'^group/(?P<group_id>\d+)/group_origin_universe/(?P<universe_id>-?\d+)/features/$',
      gcd_views.details.group_features, name='group_origin_universe_features'),
    re_path(r'^group/(?P<group_id>\d+)/group_origin_universe/(?P<universe_id>-?\d+)/feature/(?P<feature_id>\d+)/issues/$',
      gcd_views.details.group_issues_feature, name='group_origin_universe_issues_per_feature'),
    re_path(r'^group/(?P<group_id>\d+)/group_origin_universe/(?P<universe_id>-?\d+)/sequences/$',
      gcd_views.details.group_sequences, name='group_origin_universe_sequences'),
    re_path(r'^group_name/(?P<group_name_id>\d+)/group_origin_universe/(?P<universe_id>-?\d+)/issues/$',
      gcd_views.details.group_name_issues, name='group_name_origin_universe_issues'),
    re_path(r'^group/(?P<group_id>\d+)/group_origin_universe/(?P<universe_id>-?\d+)/story_universe/(?P<story_universe_id>-?\d+)/$',
      gcd_views.details.group_issues, name='group_origin_universe_story_issues_per_universe'),
