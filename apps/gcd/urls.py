...
urlpatterns += [
    ...
    re_path('^covers_for_replacement.lasso/$',
      bv.RedirectView.as_view(url='/covers_to_replace/',
                              permanent=True)),
    re_path('^index.lasso/$', bv.RedirectView.as_view(url='/', permanent=True)),
    re_path('^donate.lasso/$', bv.RedirectView.as_view(url='/donate/',
                                                permanent=True)),
    re_path(r'^graphics/covers/', bv.RedirectView.as_view(url=None, permanent=True)),
    re_path('^coversubmit/index.lasso/$', bv.RedirectView.as_view(url=None,
                                                           permanent=True)),
