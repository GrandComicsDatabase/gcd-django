...
urlpatterns = [
    ...
    url(r'^publisher/(?P<publisher_id>\d+)/monthly_issues_pub_date/year/(?P<year>\d{4})/month/(?P<month>\d{1,2})/$',
      gcd_views.details.publisher_monthly_covers,
      {'use_on_sale': False, 'overview': True }, name='publisher_monthly_issues_pub_date'),
    url(r'^publisher/(?P<publisher_id>\d+)/creator/(?P<creator_id>\d+)/issues/$',
      gcd_views.details.creator_issues, name='publisher_creator_issues'),
    url(r'^publisher/(?P<publisher_id>\d+)/creator_name/(?P<creator_name_id>\d+)/issues/$',
      gcd_views.details.creator_name_issues, name='publisher_creator_name_issues'),
    url(r'^publisher/(?P<publisher_id>\d+)/creators/$',
      gcd_views.details.publisher_creators, name='publisher_creators'),
    url(r'^publisher/(?P<publisher_id>\d+)/creator_names/$',
    ...
    url(r'^creator_name/(?P<creator_name_id>\d+)/series/(?P<series_id>\d+)/issues/$',
        gcd_views.details.creator_sequences, {'creator_name': True },
    ...
    url(r'^series/(?P<series_id>\d+)/creator/(?P<creator_id>\d+)/issues/$',
      gcd_views.details.creator_issues, name='series_creator_issues'),
    url(r'^series/(?P<series_id>\d+)/creator_name/(?P<creator_name_id>\d+)/issues/$',
    ...
    url(r'^feature/(?P<feature_id>\d+)/creator/(?P<creator_id>\d+)/issues/$',
      gcd_views.details.creator_issues, name='feature_creator_issues'),
    url(r'^feature/(?P<feature_id>\d+)/creator_name/(?P<creator_name_id>\d+)/issues/$',
    ...
    url(r'^feature/(?P<feature_id>\d+)/creator_names/$',
    ...
    url(r'^character_name/(?P<character_name_id>\d+)/issues/$',
      gcd_views.details.character_name_issues, name='character_name_issues'),
    url(r'^character_name/(?P<character_name_id>\d+)/issues/universe/(?P<universe_id>-?\d+)/$',
    ...
    url(r'^character/(?P<character_id>\d+)/issues/character_universe/(?P<universe_id>-?\d+)/$',
      gcd_views.details.character_issues, name='character_issues_per_universe'),
    url(r'^character/(?P<character_id>\d+)/issues/character_universe/(?P<universe_id>-?\d+)/story_universe/(?P<story_universe_id>-?\d+)/$',
      gcd_views.details.character_issues, name='character_story_issues_per_universe'),
    url(r'^character/(?P<character_id>\d+)/issues/story_universe/(?P<story_universe_id>-?\d+)/$',
      gcd_views.details.character_issues, name='character_story_issues_per_universe'),
    ...
    url(r'^character/(?P<character_id>\d+)/issues/series/(?P<series_id>-?\d+)/$',
      gcd_views.details.character_issues_series, name='character_issues_per_series'),
    url(r'^character/(?P<character_id>\d+)/series/$',
    ...
    url(r'^character/(?P<character_id>\d+)/creator_names/$',
      gcd_views.details.character_creators, {'creator_names': True}, name='character_creator_names'),
    url(r'^character/(?P<character_id>\d+)/creator/(?P<creator_id>\d+)/issues/$',
      gcd_views.details.creator_issues, name='character_creator_issues'),
    url(r'^character/(?P<character_id>\d+)/creator_name/(?P<creator_name_id>\d+)/issues/$',
    ...
    url(r'^group_name/(?P<group_name_id>\d+)/issues/$',
      gcd_views.details.group_name_issues, name='group_name_issues'),
    url(r'^group_name/(?P<group_name_id>\d+)/issues/universe/(?P<universe_id>-?\d+)/$',
    ...
    url(r'^group/(?P<group_id>\d+)/issues/group_universe/(?P<universe_id>-?\d+)/$',
      gcd_views.details.group_issues, name='group_issues_per_universe'),
    url(r'^group/(?P<group_id>\d+)/issues/group_universe/(?P<universe_id>-?\d+)/story_universe/(?P<story_universe_id>-?\d+)/$',
      gcd_views.details.group_issues, name='group_story_issues_per_universe'),
    url(r'^group/(?P<group_id>\d+)/issues/story_universe/(?P<story_universe_id>-?\d+)/$',
      gcd_views.details.group_issues, name='group_story_issues_per_universe'),
    url(r'^group/(?P<group_id>\d+)/creator/(?P<creator_id>\d+)/issues/$',
      gcd_views.details.creator_issues, name='group_creator_issues'),
    url(r'^group/(?P<group_id>\d+)/creator_name/(?P<creator_name_id>\d+)/issues/$',
    ...
    url(r'^group/(?P<group_id>\d+)/creator_names/$',
