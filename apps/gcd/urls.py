...
urlpatterns = [
    ...
    path('publisher/name/<str:publisher_name>/sort/<str:sort>/',
         gcd_views.search.publisher_by_name, name='publisher_by_name'),
    path('publisher/name/<str:publisher_name>/',
         gcd_views.search.publisher_by_name, name='publisher_by_name'),
    ...
    path('brand_group/name/<str:brand_group_name>/sort/<str:sort>/',
         gcd_views.search.brand_group_by_name,
         name='brand_group_by_name'),
    path('brand_group/name/<str:brand_group_name>/',
         gcd_views.search.brand_group_by_name,
         name='brand_group_by_name'),
    ...
    path('brand/name/<str:brand_name>/sort/<str:sort>/',
         gcd_views.search.brand_by_name, name='brand_by_name'),
    path('brand/name/<str:brand_name>/',
         gcd_views.search.brand_by_name, name='brand_by_name'),
    path('brand/name/',
         gcd_views.search.brand_by_name, name='brand_by_name'),
    ...
    path('brand_emblem/<int:brand_id>/',
         gcd_views.details.brand, name='show_brand'),
    path('brand_emblem/name/<str:brand_name>/sort/<str:sort>/',
         gcd_views.search.brand_by_name, name='brand_by_name'),
    path('brand_emblem/name/<str:brand_name>/',
         gcd_views.search.brand_by_name, name='brand_by_name'),
    ...
    path('indicia_publisher/name/<str:ind_pub_name>/sort/<str:sort>/',
         gcd_views.search.indicia_publisher_by_name,
         name='indicia_publisher_by_name'),
    path('indicia_publisher/name/<str:ind_pub_name>/',
         gcd_views.search.indicia_publisher_by_name,
         name='indicia_publisher_by_name'),
    ...
    path('printer/name/<str:printer_name>/sort/<str:sort>/',
         gcd_views.search.printer_by_name, name='printer_by_name'),
    path('printer/name/<str:printer_name>/',
         gcd_views.search.printer_by_name, name='printer_by_name'),
    path('printer/name/',
         gcd_views.search.printer_by_name, name='printer_by_name'),
    ...
    path('award/name/<str:award_name>/sort/<str:sort>/',
         gcd_views.search.award_by_name, name='award_by_name'),
    path('award/name/<str:award_name>/',
         gcd_views.search.award_by_name, name='award_by_name'),
    path('award/name/',
         gcd_views.search.award_by_name, name='award_by_name'),
    path('award/search/',
    ...
    path('creator/name/<str:creator_name>/sort/<str:sort>/',
    ...
    path('creator/name/<str:creator_name>/',
    ...
    path('creator_art_influence/name/<str:creator_art_influence_name>/sort/<str:sort>/',
      gcd_views.search.creator_art_influence_by_name,
      name='creator_art_influence_by_name'),
    path('creator_art_influence/name/<str:creator_art_influence_name>/',
      gcd_views.search.creator_art_influence_by_name,
      name='creator_art_influence_by_name'),
    ...
    path('creator_non_comic_work/name/<str:creator_non_comic_work_name>/sort/<str:sort>/',
      gcd_views.search.creator_non_comic_work_by_name,
      name='creator_non_comic_work_by_name'),
    path('creator_non_comic_work/name/<str:creator_non_comic_work_name>/',
      gcd_views.search.creator_non_comic_work_by_name,
      name='creator_non_comic_work_by_name'),
    ...
    path('series/<int:series_id>/issues_to_migrate/',
      ...
      name='series_migrate'),
    path('series/name/<str:series_name>/sort/<str:sort>/',
      gcd_views.search.series_by_name, name='series_by_name'),
    path('series/name/<str:series_name>/',
      gcd_views.search.series_by_name, name='series_by_name'),
    path('series/name/',
     gcd_views.search.series_by_name, name='series_by_name'),

    # Series and Issue
    path('series/name/<str:series_name>/issue/<str:issue_nr>/',
    ...
    path('feature/name/<str:feature_name>/sort/<str:sort>/',
      gcd_views.search.feature_by_name, name='feature_by_name'),
    path('feature/name/<str:feature_name>/',
      gcd_views.search.feature_by_name, name='feature_by_name'),
    path('feature/name/',
     gcd_views.search.feature_by_name, name='feature_by_name'),
    path('feature/search/',
    ...
    path('universe/name/<str:universe_name>/sort/<str:sort>/',
         gcd_views.search.universe_by_name, name='universe_by_name'),
    path('universe/name/<str:universe_name>/',
         gcd_views.search.universe_by_name, name='universe_by_name'),
    path('universe/name/',
         gcd_views.search.universe_by_name, name='universe_by_name'),
    ...
    path('character/name/<str:character_name>/sort/<str:sort>/',
      gcd_views.search.character_by_name, name='character_by_name'),
    path('character/name/<str:character_name>/',
      gcd_views.search.character_by_name, name='character_by_name'),
    path('character/name/',
     gcd_views.search.character_by_name, name='character_by_name'),
    ...
    path('group/name/<str:group_name>/sort/<str:sort>/',
      gcd_views.search.group_by_name, name='group_by_name'),
    path('group/name/<str:group_name>/',
      gcd_views.search.group_by_name, name='group_by_name'),
    path('group/name/',
     gcd_views.search.group_by_name, name='group_by_name'),
    ...
    path('writer/name/<str:writer>/sort/<str:sort>/',
      gcd_views.search.writer_by_name, name='writer_by_name'),
    path('writer/name/<str:writer>/',
      gcd_views.search.writer_by_name, name='writer_by_name'),

    path('penciller/name/<str:penciller>/sort/<str:sort>/',
      gcd_views.search.penciller_by_name, name='penciller_by_name'),
    path('penciller/name/<str:penciller>/',
      gcd_views.search.penciller_by_name, name='penciller_by_name'),

    path('inker/name/<str:inker>/sort/<str:sort>/',
      gcd_views.search.inker_by_name, name='inker_by_name'),
    path('inker/name/<str:inker>/',
      gcd_views.search.inker_by_name, name='inker_by_name'),

    path('colorist/name/<str:colorist>/sort/<str:sort>/',
      gcd_views.search.colorist_by_name, name='colorist_by_name'),
    path('colorist/name/<str:colorist>/',
      gcd_views.search.colorist_by_name, name='colorist_by_name'),

    path('letterer/name/<str:letterer>/sort/<str:sort>/',
      gcd_views.search.letterer_by_name, name='letterer_by_name'),
    path('letterer/name/<str:letterer>/',
      gcd_views.search.letterer_by_name, name='letterer_by_name'),

    path('editor/name/<str:editor>/sort/<str:sort>/',
      gcd_views.search.editor_by_name, name='editor_by_name'),
    path('editor/name/<str:editor>/',
      gcd_views.search.editor_by_name, name='editor_by_name'),

    path('story/name/<str:title>/sort/<str:sort>/',
      gcd_views.search.story_by_title, name='story_by_title'),
    path('story/name/<str:title>/',
      gcd_views.search.story_by_title, name='story_by_title'),
    ...
    path('credit/name/<str:name>/sort/<str:sort>/',
      gcd_views.search.story_by_credit, name='story_by_credit'),
    path('credit/name/<str:name>/',
      gcd_views.search.story_by_credit, name='story_by_credit'),

    # Special display pages
    path('checklist/name/<str:creator>/country/<str:country>/',
      gcd_views.details.checklist_by_name, name='checklist_by_name'),
    path('checklist/name/<str:creator>/language/<str:language>/',
      gcd_views.details.checklist_by_name, name='checklist_by_name'),
    path('checklist/name/<str:creator>/',
      gcd_views.details.checklist_by_name, name='checklist_by_name'),
    path('creator_migrate_checklist/name/<str:creator>/',
    ...
    path('job_number/name/<str:number>/sort/<str:sort>/',
      gcd_views.search.story_by_job_number_name),
    path('job_number/name/<str:number>/',
      gcd_views.search.story_by_job_number_name),
...
urlpatterns += [
    ...
    re_path('^coversubmit/index.lasso/$',
            bv.RedirectView.as_view(url=None, permanent=True)),
    path('creator_checklist/name/<str:creator>/country/<str:country>/',
         bv.RedirectView.as_view(
          url='/checklist/name/%(creator)s/country/%(country)s/',
          permanent=True)),
    path('creator_checklist/name/<str:creator>/language/<str:language>/',
         bv.RedirectView.as_view(
          url='/checklist/name/%(creator)s/language/%(language)s/',
          permanent=True)),
    path('creator_checklist/name/<str:creator>/',
