...
urlpatterns = [
    ...
    path('printer/name/<path:printer_name>/sort/<path:sort>/',
    ...
    path('feature/name/<path:feature_name>/sort/<path:sort>/',
    ...
    path('universe/name/<path:universe_name>/sort/<path:sort>/',
    ...
    path('group/name/<path:group_name>/sort/<path:sort>/',
    ...
    # Attribute searches
    path('story_by_character/<path:character>/sort/<path:sort>/',
      gcd_views.search.story_by_character, name='story_by_character'),
    path('story_by_character/<path:character>/',
      gcd_views.search.story_by_character, name='story_by_character'),
