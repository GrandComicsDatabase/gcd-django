...
urlpatterns = patterns('',
    ...
    url(r'^creator_art_influence/(?P<creator_art_influence_id>\d+)/$',
     'apps.gcd.views.details.creator_art_influence', name='show_creator_art_influence'),
    url(r'^creator_art_influence/name/(?P<creator_art_influence_name>.+)/sort/(?P<sort>.+)/$',
     'apps.gcd.views.search.creator_art_influence_by_name',
    ...
    url(r'^creator_non_comic_work/(?P<creator_non_comic_work_id>\d+)/$',
     'apps.gcd.views.details.creator_non_comic_work', name='show_creator_non_comic_work'),
