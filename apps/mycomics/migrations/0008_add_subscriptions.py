...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mycomics_subscription', (
            ...
            ('last_pulled', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('mycomics', ['Subscription'])
    ...
    models = {
        ...
        'mycomics.collectionitem': {
            'Meta': {'ordering': "['issue__series__sort_name', 'issue__sort_code', 'id']", 'object_name': 'CollectionItem', 'db_table': "'mycomics_collection_item'"},
