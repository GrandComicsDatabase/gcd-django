...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CollectionItem.market_value'
        db.alter_column('mycomics_collection_item', 'market_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'CollectionItem.sell_price'
        db.alter_column('mycomics_collection_item', 'sell_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'CollectionItem.price_paid'
        db.alter_column('mycomics_collection_item', 'price_paid', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'CollectionItem.market_value'
        db.alter_column('mycomics_collection_item', 'market_value', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'CollectionItem.sell_price'
        db.alter_column('mycomics_collection_item', 'sell_price', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'CollectionItem.price_paid'
        db.alter_column('mycomics_collection_item', 'price_paid', self.gf('django.db.models.fields.FloatField')(null=True))
    ...
    models = {
        ...
        'mycomics.collectionitem': {
            ...
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mycomics.Location']", 'null': 'True', 'blank': 'True'}),
            ...
            'purchase_location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mycomics.PurchaseLocation']", 'null': 'True', 'blank': 'True'}),
