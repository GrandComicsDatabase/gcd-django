...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Collector.default_currency'
        db.add_column('mycomics_collector', 'default_currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['stddata.Currency']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Collector.default_currency'
        db.delete_column('mycomics_collector', 'default_currency_id')
